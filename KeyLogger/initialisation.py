...
# On récupère le nom d'utilisateur de l'ordinateur, cela nous servira pour
USER_NAME = getpass.getuser()

# le chemin où se trouve le fichier python
file_path = os.path.dirname(os.path.realpath(__file__))

	

#Ici on cree et on donne le contenu du script du fichier FirstBoot.bat
...
#Ici on cree et on donne le contenu du script du fichier FirstBoot.vbs
...
#Ici on cree et on donne le contenu du script du fichier StopALL.bat
...
#Ici on cree et on donne le contenu du script du fichier StopALL.vbs
